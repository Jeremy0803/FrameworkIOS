...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        UINavigationBar.appearance().tintColor = UIColor.flatBlue
        UINavigationBar.appearance().titleTextAttributes = [NSForegroundColorAttributeName : UIColor.flatBlue]
        // load and save UUID
        Common.loadUUID()
        print("UUID \(Common.CommonValue.UUID!)")
